...
public:
     ...
     */
    CustomIBHydrodynamicForceEvaluator(std::string object_name,
                                 double rho,
                                 double mu,
                                 double current_time,
     ...
     */
    virtual ~CustomIBHydrodynamicForceEvaluator();
...
private:
     ...
     */
    CustomIBHydrodynamicForceEvaluator(const CustomIBHydrodynamicForceEvaluator& from) = delete;
     ...
     */
    CustomIBHydrodynamicForceEvaluator& operator=(const CustomIBHydrodynamicForceEvaluator& that) = delete;
